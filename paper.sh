...
# # # traced models
# python3 eval_lm.py -m models/llama_traced -o outputs/llama_traced -z -b 7bU
# python3 eval_lm.py -m models/llama_traced -o outputs/llama_traced -b 7bU
# python3 eval_lm.py -m models/llama_chat_traced -o outputs/llama_chat_traced -z -b 7bUc
# python3 eval_lm.py -m models/llama_chat_traced -o outputs/llama_chat_traced -b 7bUc
# python3 eval_lm.py -m models/llama_code_traced -o outputs/llama_code_traced -z -b 7bCodeU
# python3 eval_lm.py -m models/llama_code_traced -o outputs/llama_code_traced -b 7bCodeU

# # # slp models
# python3 eval_lm.py -m models/llama_slp -o outputs/llama_slp -z -b 7bU
# python3 eval_lm.py -m models/llama_slp -o outputs/llama_slp -b 7bU
# python3 eval_lm.py -m models/llama_chat_slp -o outputs/llama_chat_slp -z -b 7bUc
# python3 eval_lm.py -m models/llama_chat_slp -o outputs/llama_chat_slp -b 7bUc
# python3 eval_lm.py -m models/llama_code_slp -o outputs/llama_code_slp -z -b 7bCodeU
# python3 eval_lm.py -m models/llama_code_slp -o outputs/llama_code_slp -b 7bCodeU